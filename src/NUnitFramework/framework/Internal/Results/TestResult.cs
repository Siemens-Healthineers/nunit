...
namespace NUnit.Framework.Internal
{
    ...
    public abstract class TestResult : LongLivedMarshalByRefObject, ITestResult
    {
        ...
        public abstract TestResult CalculateDeltaWithPrevious(TestResult previous, Exception? exception = null);
        ...
        /// <see cref="CalculateDeltaWithPrevious(TestResult, Exception?)"/> of the derived classes.
        /// </summary>
        /// <param name="deltaResult">An empty TestResult to store the delta result.</param>
        /// <param name="previous">The previous TestResult to compare against.</param>
        /// <param name="exception">An optional exception to consider when calculating the delta.</param>
        protected void CalculateDeltaWithPrevious(TestResult deltaResult, TestResult previous, Exception? exception = null)
        {
